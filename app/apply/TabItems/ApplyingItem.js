...
import ListEmptyView  from '../../common/CommonListEmpty'
...
export default class ApplyingItem extends Component {
    constructor(props) {
        super(props)
        that = this
        this.state = {
